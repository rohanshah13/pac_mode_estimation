...
[numSamples, success] = kl_lucb.KL_LUCB(numberIterations, randomSeed,
...
write_data('KL-LUCB',avgSamples, se, args.delta, failure_probability, args.random_seed, args.outfile)
